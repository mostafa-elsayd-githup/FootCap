        ...
        <SwiperSlide className={styles.club_item}>
          <Card className={styles.product_card}>
            ...
            <Card.Body className={styles.card}>
              ...
              <Link
                href={`/Collection/man_colliction/shrat_clube_pages/?club=Liverpool`}
        ...
        <SwiperSlide className={styles.club_item}>
          <Card className={styles.product_card}>
            ...
            <Card.Body className={styles.card}>
              ...
              <Link
                href="/Collection/man_colliction/shrat_clube_pages/?club=alahly"
                className={styles.Button}
              >
                SHOP NOW
              </Link>
        ...
        <SwiperSlide className={styles.club_item}>
          <Card className={styles.product_card}>
            ...
            <Card.Body className={styles.card}>
              ...
              <Link
                href="/Collection/man_colliction/shrat_clube_pages/?club=Real Madrid"
                className={styles.Button}
              >
                SHOP NOW
              </Link>
        ...
        <SwiperSlide className={styles.club_item}>
          <Card className={styles.product_card}>
            ...
            <Card.Body className={styles.card}>
              ...
              <Link
                href="/Collection/man_colliction/shrat_clube_pages/?club=Man United"
                className={styles.Button}
              >
                SHOP NOW
              </Link>
        ...
        <SwiperSlide className={styles.club_item}>
          <Card className={styles.product_card}>
            ...
            <Card.Body className={styles.card}>
              ...
              <Link
                href="/Collection/man_colliction/shrat_clube_pages/?club=Bayern Munich"
                className={styles.Button}
              >
                SHOP NOW
              </Link>
        ...
        <SwiperSlide className={styles.club_item}>
          <Card className={styles.product_card}>
            ...
            <Card.Body className={styles.card}>
              ...
              <Link
                href="/Collection/man_colliction/shrat_clube_pages/?club=ArsenalClub"
                className={styles.Button}
              >
                SHOP NOW
              </Link>
