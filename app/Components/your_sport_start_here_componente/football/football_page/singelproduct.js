  ...
  return (
    ...
    >
        ...
        >
          ...
          <button
            ...
            onMouseDown={() => {
              ...
              if (!pending) {
                Router.push(
                  `/Components/your_sport_start_here_componente/football/${productItem.id}`,
                );
              }
            }}
            style={{
        ...
        <div className={styles.small_products}>
          {productItem.url.map((style) => (
            <div key={style.id} className={styles.small_img}>
              <Link
                href={`/Components/your_sport_start_here_componente/football/${style.id}`}
              >
                <Card.Img
                  variant="top"
                  src={style.img_url}
      ...
      <Card.Body className={styles.card_body}>
        <Link
          href={`/Components/your_sport_start_here_componente/football/${productItem.id}`}
        >
