  ...
  return (
    ...
    >
        ...
        >
          ...
          <button
            ...
            onMouseDown={() => {
              ...
              if (!pending) {
                Router.push(
                  `/Components/what_is_hot_componante/simpsone/${productItem.id}`,
                );
              }
            }}
            style={{
        ...
        <div className={styles.small_products}>
          {productItem.url.map((style) => (
            <div key={style.id} className={styles.small_img}>
              <Link
                href={`/Components/what_is_hot_componante/simpsone/${style.id}`}
              >
                <Card.Img
                  variant="top"
                  src={style.img_url}
      ...
      <Card.Body className={styles.card_body}>
        <Link
          href={`/Components/what_is_hot_componante/simpsone/${productItem.id}`}
        >
