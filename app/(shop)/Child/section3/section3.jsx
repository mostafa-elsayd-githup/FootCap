          ...
          <Swiper spaceBetween={20} slidesPerView={"auto"}>
            <SwiperSlide className={styles.club_item}>
              <Card className={styles.product_card}>
                <Card.Img
                  variant="top"
                  src="https://assets.adidas.com/images/w_450,f_auto,q_auto/f3174714b5cd44b98340a9ac00042f87_9366/G27627_00_plp_standard.WebP"
                />
            ...
            <SwiperSlide className={styles.club_item}>
              <Card className={styles.product_card}>
                <Card.Img
                  variant="top"
                  src="https://assets.adidas.com/images/w_450,f_auto,q_auto/db47e3bdf8d64cf19371ae8a0037439a_9366/GW6422_00_plp_standard.WebP"
                />
                <Card.Body className={styles.card}>
            ...
            <SwiperSlide className={styles.club_item}>
              <Card className={styles.product_card}>
                <Card.Img
                  variant="top"
                  src="https://assets.adidas.com/images/w_450,f_auto,q_auto/87d9ca0826e344bc82f3aaf50115e2bc_9366/F35556_00_plp_standard.WebP"
                />
                <Card.Body className={styles.card}>
            ...
            <SwiperSlide className={styles.club_item}>
              <Card className={styles.product_card}>
                <Card.Img
                  variant="top"
                  src="https://assets.adidas.com/images/w_450,f_auto,q_auto/647c700ff8bd4aec99f2ae8c01720810_9366/GW6424_00_plp_standard.WebP"
                />
                <Card.Body className={styles.card}>
                  <h5 className={styles.name}>
                    Tensaur Sport Training Lace Shoes
            ...
            <SwiperSlide className={styles.club_item}>
              <Card className={styles.product_card}>
                <Card.Img
                  variant="top"
                  src="/al_ahly_shart_section3_kids.WebP"
                />
                <Card.Body className={styles.card}>
                  <h5 className={styles.name}>
            ...
            <SwiperSlide className={styles.club_item}>
              <Card className={styles.product_card}>
                <Card.Img variant="top" src="/shart_section3_kids.WebP" />
                <Card.Body className={styles.card}>
                  <h5 className={styles.name}>
